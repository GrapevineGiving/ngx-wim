(function (global, factory) {
    ...
    var WimService = /** @class */ (function () {
        ...
        /** @nocollapse */ WimService.ngInjectableDef = core.ɵɵdefineInjectable({ token: WimService, factory: function WimService_Factory(t) { return new (t || WimService)(core.ɵɵinject(platformBrowser.DomSanitizer)); }, providedIn: 'root' });
        return WimService;
    }());
    /*@__PURE__*/ core.ɵsetClassMetadata(WimService, [{
    ...
    var WimDirective = /** @class */ (function () {
        ...
        /** @nocollapse */ WimDirective.ngDirectiveDef = core.ɵɵdefineDirective({ type: WimDirective, selectors: [["", "wim", ""]], factory: function WimDirective_Factory(t) { return new (t || WimDirective)(core.ɵɵdirectiveInject(core.ElementRef), core.ɵɵdirectiveInject(core.Renderer2), core.ɵɵdirectiveInject(WimService)); }, inputs: { wim: "wim" }, features: [core.ɵɵNgOnChangesFeature()] });
        return WimDirective;
    }());
    /*@__PURE__*/ core.ɵsetClassMetadata(WimDirective, [{
            type: core.Directive,
            args: [{
                    selector: '[wim]',
                }]
        }], function () { return [{ type: core.ElementRef }, { type: core.Renderer2 }, { type: WimService }]; }, { wim: [{
                type: core.Input,
                args: ['wim']
            }] });
    ...
    var WimModule = /** @class */ (function () {
        ...
        /** @nocollapse */ WimModule.ngModuleDef = core.ɵɵdefineNgModule({ type: WimModule });
        /** @nocollapse */ WimModule.ngInjectorDef = core.ɵɵdefineInjector({ factory: function WimModule_Factory(t) { return new (t || WimModule)(); }, providers: [WimService], imports: [[]] });
        return WimModule;
    }());
    /*@__PURE__*/ core.ɵɵsetNgModuleScope(WimModule, { declarations: [WimDirective], exports: [WimDirective] });
    /*@__PURE__*/ core.ɵsetClassMetadata(WimModule, [{
            type: core.NgModule,
            args: [{
